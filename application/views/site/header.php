...
<head>
  ...
  <link rel="icon" href="assets/images/LOGO USI-01.png" type="image/gif">
  <meta charset="utf-8">
  ...
  <link href="css_c/creative.min.css" rel="stylesheet">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="<?php echo site_url('homepage/down');?>">ดาวน์โหลด</a> 
          </li>
        </ul>
      </div>
    </div>
